...
<head>
    ...
    <!--Font awesome 4.7-->
    <link rel="stylesheet" href="assets/font-awesome-4.7.0/path/to/font-awesome/css/font-awesome.min.css">
    <!-- overlayScrollbars -->
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item has-treeview ">
                            <a href="#" class="nav-link">
                                <i class="nav-icon fas fa-envelope-open" alt=""></i>
                                <p>
                                    Surat Keluar
                                    <i class="right fas fa-angle-left"></i>
                                </p>
                        ...
                        <li class="nav-item has-treeview ">
                            <a href="#" class="nav-link ">
                                <i class="nav-icon fas fa-archive" alt=""></i>
                                <p>
                                    E-Arsip
                                    <i class="right fas fa-angle-left"></i>
                                </p>
